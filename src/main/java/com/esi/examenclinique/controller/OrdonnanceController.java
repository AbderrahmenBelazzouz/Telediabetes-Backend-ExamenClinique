...
public class OrdonnanceController {
    ...
    public DoseJour adddoses(@PathVariable Long idec, @RequestBody DoseJour doses){
        return ordonnanceService.saveDoses(idec, doses);
    }

    @GetMapping("/doses")
    public List<DoseJour> getDoses(){
        return ordonnanceService.getDoses();
    }
